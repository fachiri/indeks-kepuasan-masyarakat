...
Route::get('/kritik-dan-saran', [IndexController::class, 'kritik_saran'])->name('kritik_saran');
Route::post('/kritik-dan-saran', [IndexController::class, 'kritik_saran_store'])->name('kritik_saran.store');
